...
!macro CustomCodePostInstall
	Rename "$INSTDIR\jre1.8.0_341\bin" "$INSTDIR\bin"
	Rename "$INSTDIR\jre1.8.0_341\legal" "$INSTDIR\legal"
	Rename "$INSTDIR\jre1.8.0_341\lib" "$INSTDIR\lib"
	Rename "$INSTDIR\jre1.8.0_341\COPYRIGHT" "$INSTDIR\COPYRIGHT"
	Rename "$INSTDIR\jre1.8.0_341\LICENSE" "$INSTDIR\LICENSE"
	Rename "$INSTDIR\jre1.8.0_341\README.txt" "$INSTDIR\README.txt"
	Rename "$INSTDIR\jre1.8.0_341\release" "$INSTDIR\release"
	Rename "$INSTDIR\jre1.8.0_341\THIRDPARTYLICENSEREADME.txt" "$INSTDIR\THIRDPARTYLICENSEREADME.txt"
	Rename "$INSTDIR\jre1.8.0_341\THIRDPARTYLICENSEREADME-JAVAFX.txt" "$INSTDIR\THIRDPARTYLICENSEREADME-JAVAFX.txt"
	Rename "$INSTDIR\jre1.8.0_341\Welcome.html" "$INSTDIR\Welcome.html"
	RMDir "$INSTDIR\jre1.8.0_341"
